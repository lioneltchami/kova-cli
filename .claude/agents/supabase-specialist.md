...
- .claude/context/rules+examples/supabase-database-patterns.md - **PRIMARY** Database design, RLS policies, and Supabase service patterns
- .claude/context/rules+examples/api-auth-patterns.md - Authentication integration and security patterns
- .claude/context/rules+examples/database-examples.md - Database implementation examples and schema patterns

**Secondary References:**

- .claude/context/rules+examples/project-organization-patterns.md - Project structure for database work and migrations
- .claude/context/rules+examples/typescript-patterns.md - TypeScript patterns for database types and client integration
...
- `database-examples.md`: Used for practical database design examples, migration patterns, and query optimization
