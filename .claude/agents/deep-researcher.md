...
1. Scan the `.claude/context/rules+examples/` directory to identify all available pattern documentation
2. Scan the `.claude/context/rules+examples/` directory to identify all available code examples
...
- .claude/context/rules+examples/context7-mcp-patterns.md - **MANDATORY** Context7-first research workflow and MCP integration patterns

**Secondary References:**

- ALL files in `.claude/context/rules+examples/` - For understanding project constraints and technology stack during research
...
See .claude/context/rules+examples/context7-mcp-patterns.md for detailed research workflow patterns.
