...
2. **Context Integration**: Scan `.claude/context/rules+examples/` directory for:
...
3. **Load Code Examples**: Review `.claude/context/rules+examples/` for existing implementations
...
- .claude/context/rules+examples/performance-testing-patterns.md - Performance optimization patterns and Core Web Vitals strategies

**Secondary References:**

- .claude/context/rules+examples/nextjs-react-patterns.md - React performance optimization and Next.js performance patterns
- .claude/context/rules+examples/supabase-database-patterns.md - Database performance optimization and query tuning
- .claude/context/rules+examples/ui-styling-patterns.md - CSS performance and styling optimization patterns
...
See .claude/context/rules+examples/performance-testing-patterns.md for detailed documentation templates.
...
- See .claude/context/rules+examples/performance-testing-patterns.md for detailed implementation patterns
...
- See .claude/context/rules+examples/nextjs-react-patterns.md for complete bundle optimization configurations
...
- See .claude/context/rules+examples/supabase-database-patterns.md for database optimization patterns
...
- See .claude/context/rules+examples/performance-testing-patterns.md for complete implementation
...
- See .claude/context/rules+examples/nextjs-react-patterns.md for image optimization patterns
...
- See .claude/context/rules+examples/nextjs-react-patterns.md for React performance patterns
...
- See .claude/context/rules+examples/supabase-database-patterns.md for database performance patterns
...
- See .claude/context/rules+examples/nextjs-react-patterns.md for infrastructure performance patterns
...
- See .claude/context/rules+examples/performance-testing-patterns.md for monitoring implementation
...
- See .claude/context/rules+examples/performance-testing-patterns.md for complete budget configuration
...
- See .claude/context/rules+examples/nextjs-react-patterns.md for complete code splitting strategies
