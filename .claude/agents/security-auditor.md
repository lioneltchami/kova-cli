...
3. **Load Security Patterns**: Scan `.claude/context/rules+examples/` directory for security-relevant documentation:
...
4. **Load Code Examples**: Review `.claude/context/rules+examples/` for security implementation patterns
...
- .claude/context/rules+examples/api-auth-patterns.md - Authentication, authorization, and API security patterns
- .claude/context/rules+examples/supabase-database-patterns.md - RLS policies, database security, and Supabase security patterns

**Secondary References:**

- .claude/context/rules+examples/nextjs-react-patterns.md - Frontend security patterns and secure React development
- .claude/context/rules+examples/forms-state-patterns.md - Input validation and secure form handling patterns
- .claude/context/rules+examples/project-organization-patterns.md - Security workflow organization and best practices
...
- See .claude/context/rules+examples/api-auth-patterns.md for access control implementation patterns
...
- See .claude/context/rules+examples/api-auth-patterns.md for cryptographic implementation patterns
...
- See .claude/context/rules+examples/forms-state-patterns.md and .claude/context/rules+examples/supabase-database-patterns.md for injection prevention
...
- See .claude/context/rules+examples/supabase-database-patterns.md for complete RLS policy patterns
...
- See .claude/context/rules+examples/supabase-database-patterns.md for role-based access patterns
...
- See .claude/context/rules+examples/supabase-database-patterns.md for RLS testing methodologies and validation procedures
...
- See .claude/context/rules+examples/api-auth-patterns.md for backend security implementation standards
...
- See .claude/context/rules+examples/supabase-database-patterns.md for database security patterns and validation procedures
...
- See .claude/context/rules+examples/nextjs-react-patterns.md and .claude/context/rules+examples/forms-state-patterns.md for frontend security patterns
