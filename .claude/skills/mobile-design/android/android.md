...
Material Design 3 and Android platform guidelines. 50+ rules across 10 categories covering Material You, dynamic color, navigation patterns, Jetpack Compose components, accessibility, adaptive layouts, and Android-specific interactions. Each rule includes Compose and XML examples.
