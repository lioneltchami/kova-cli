...
70+ mental models and psychological principles organized for marketing application. These thinking tools help you understand why people buy, how to influence behavior ethically, and how to make better marketing decisions.

## When to Use

- "Psychology", "mental models", "cognitive bias"
- "Persuasion", "behavioral science"
- "Why people buy", "decision-making"
- "Consumer behavior"
- When you need to understand customer psychology for copy, CRO, or strategy

## How to Use This Skill

1. Identify which mental models apply to your situation
2. Understand the psychology behind the model
3. Apply specific marketing applications
4. Implement ethically
...
**Marketing application**: Identify your North Star and align all efforts toward it.
...
- `cro/page-cro.md` - Apply psychology to page optimization
- `marketing/references/copywriting-frameworks.md` - Write copy using psychological principles
- `cro/popup-cro.md` - Use triggers and psychology in popups
- `pricing/skill-overview.md` - Apply pricing psychology
- `cro/ab-testing.md` - Test psychological hypotheses
