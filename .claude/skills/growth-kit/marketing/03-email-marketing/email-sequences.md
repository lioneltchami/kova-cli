...
**Output:** Complete email sequences with subject lines, preview text, full copy, send timing, and CTAs.
...
5. **What voice/brand?** (Run voice-profiler skill first if not defined)
...
## Email Types Reference: Lifecycle Matrix

A comprehensive guide to SaaS/product lifecycle emails. Use this as an audit checklist and implementation reference.
...
**Sequence structure:**
1. Value summary: What they've accomplished
2. Feature comparison: What they're missing
3. Social proof: Who else upgraded
4. Urgency: Trial ending, limited offer
5. Final: Last chance + easy path
...
**Segmentation by trial engagement:**
...
- Not "made money" but "$47,329 in one day"
- Not "many customers" but "2,847 customers"
...
- **voice-profiler** - Ensures email voice matches brand
- **hook-finder** - The angle informs the pitch
- **lead-magnet-builder** - The sequence delivers the lead magnet
- **direct-response-copy** - Individual emails use copy principles

**email-sequences feeds:**

- **content-repurposer** - Best emails can become social content
- **newsletter-templates** - Sequence insights inform newsletter strategy

**The flow:**

1. **lead-magnet** creates the opt-in offer
2. **email-sequences** builds the welcome to conversion path
