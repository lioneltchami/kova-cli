...
Plan, design, and implement A/B tests and experiments that produce statistically valid, actionable results.

## When to Use

- "A/B test", "split test", "experiment"
- "Test this change", "variant copy"
- "Multivariate test", "hypothesis"
- For tracking implementation, use analytics skills
...
### Test Duration
```
Duration = (Sample size per variant x Variants) / (Daily traffic x Conversion rate)
```
...
Statistical does not equal Practical
...
- `cro/page-cro.md` - For generating test ideas
- `marketing/references/copywriting-frameworks.md` - For creating variant copy
- `marketing/references/marketing-psychology.md` - For psychology-based hypotheses
