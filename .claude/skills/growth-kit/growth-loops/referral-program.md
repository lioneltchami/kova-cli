...
Expert guidance for designing, launching, and optimizing referral programs and affiliate partnerships. Covers program structure, incentive design, viral mechanics, fraud prevention, and optimization. Turn customers into a growth engine.
...
**Trigger phrases:**
- "referral program", "refer a friend", "referral marketing"
- "affiliate program", "affiliate marketing", "partner program"
- "ambassador program", "word of mouth", "viral loop"
- "referral incentive", "referral reward"
- "customer advocacy", "brand ambassador"

**Use cases:**
- Designing a new referral program
- Optimizing an underperforming program
- Creating affiliate partnerships
- Setting incentive structures
...
- Engineering resources for custom implementation?
...
### Affiliate Enablement Checklist
...
```
Average successful referrals per referring customer
```
...
Before launching:
- [ ] Incentive structure documented and approved
- [ ] Reward amounts validated against unit economics
- [ ] Sharing mechanism tested across channels
- [ ] Landing page optimized for conversions
- [ ] Fraud prevention measures in place
- [ ] Tracking and attribution working
...
- **marketing/05-gtm/launch-checklists**: Launch referral program effectively
- **marketing/03-email-marketing/email-sequences**: Referral nurture campaigns
- **marketing/references/marketing-psychology**: Referral motivation principles
- **analytics skill**: Referral attribution tracking
- **pricing/skill-overview.md**: Structure rewards relative to LTV
