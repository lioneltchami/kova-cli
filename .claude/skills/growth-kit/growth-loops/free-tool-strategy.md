...
Expert guidance for planning, building, and promoting free tools that generate leads, attract organic traffic, and build brand awareness. Covers tool ideation, validation, SEO strategy, lead capture approaches, MVP scoping, and measurement. Bridge engineering and marketing for sustainable growth.
...
**Trigger phrases:**
- "free tool", "marketing tool", "lead gen tool"
- "engineering as marketing", "build a tool for leads"
- "calculator", "generator", "analyzer", "grader"
- "interactive tool", "free resource"
- "tool-based lead generation"

**Use cases:**
- Planning a free tool strategy
- Evaluating tool ideas
- Scoping an MVP for a marketing tool
- Optimizing an existing free tool
...
Before building:
- [ ] Idea validated against scorecard (25+ points)
- [ ] Search demand confirmed
- [ ] Unique angle identified
- [ ] MVP scope defined
- [ ] Lead capture strategy chosen
- [ ] Success metrics defined
- [ ] Promotion plan outlined
- [ ] Maintenance plan considered

Before launching:
- [ ] Tool works reliably on all devices
...
- **cro/page-cro**: Optimize tool landing page
- **seo/workflow-a-audit**: SEO-optimize the tool
- **analytics skill**: Measure tool usage
- **marketing/03-email-marketing/email-sequences**: Nurture leads from tool
- **seo/seo-master-reference**: Programmatic SEO for tool-based pages at scale
